...
3. Assign the created Data Asset into one of your mesh spawn data, `FTurboSequence_MeshSpawnData_Lf` somewhere in your own animation controller where it makes sense for you.
